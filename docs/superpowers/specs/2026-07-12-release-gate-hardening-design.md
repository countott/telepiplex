...
Only `main` changes. The download, search, rename, and sync source branches remain unchanged. Existing deferred business decisions remain outside this work.
...
This invariant applies equally to future Providers and is not special-cased for download.
