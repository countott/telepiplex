...
class SearchFeatureTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_conflicting_provider_dates_keep_ten_episodes_through_download_once(self):
        ...
        runtime = FeatureRuntime(
            manifest={"plugin_id": "search", "version": "2.2.1", "host_api": ">=1.1,<2.0"},
...
class FeatureSourceContractTest(unittest.TestCase):
    def test_release_identity_requires_host_photo_action_contract(self):
        ...
        self.assertEqual(project["project"]["version"], "2.2.1")
        self.assertEqual(
    ...
    def test_readme_build_example_uses_current_version(self):
        ...
        self.assertIn("/tmp/search-2.2.1.tpx", source)
        ...
        self.assertNotIn("dist/search-2.2.1.tpx", source)
