...
**Files:**
- Create: `src/telepiplex_search/input_contract.py`
- Modify: `src/telepiplex_search/search_resolution.py`
- Modify: `src/telepiplex_search/search_query.py`
...
**Files:**
- Create: `src/telepiplex_search/direct_link.py`
...
**Files:**
- Create: `src/telepiplex_search/series_scope.py`
...
- [ ] Preserve release/rename handoff metadata.
- [ ] Run focused tests.
...
**Files:**
- Delete: `src/telepiplex_search/entity_registry.py`
...
**Interfaces:**
- Produces: a stateless `SearchFeature` whose selected task contract is carried only through download.
...
- Test: `/Users/young/Documents/telepiplex/tests/test_plugin_handler.py`
- Test: `/Users/young/Documents/telepiplex/tests/test_operation_pipeline_e2e.py`
...
- Modify: `README.md`
- Modify: `/Users/young/Documents/telepiplex/app/115bot.py`
