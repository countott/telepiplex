...
本规格已获用户确认，并于 2026-08-14 完成实现。完整 Search 测试结果为
`414 passed, 2 skipped, 65 subtests passed`；同日实时诊断确认中文页可解析
15 条扁平记录，英文同一 QID 页面可解析两季 16 条记录，合并后正确得到
第 1 季 8/8、第 2 季已播 7/8 与未来第 8 集。
