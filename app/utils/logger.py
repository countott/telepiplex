...
DEFAULT_CORE_LOG_NAME = "telepiplex.core"
DEFAULT_CORE_LOG_FILENAME = "telepiplex-core.log"
...
def core_log_path(config_root: str | Path) -> Path:
    return Path(config_root) / "logs" / DEFAULT_CORE_LOG_FILENAME
...
def configure_root_logger(
    *,
    ...
    logger_name: str = DEFAULT_CORE_LOG_NAME,
) -> logging.Logger:
    ...
    logger = logging.getLogger(str(logger_name or DEFAULT_CORE_LOG_NAME))
