...
class PluginManifestTest(unittest.TestCase):
    ...
    def test_valid_manifest_is_immutable_and_supports_core_api(self):
        ...
        self.assertTrue(manifest.supports_core("1.0"))
        self.assertTrue(manifest.supports_core("1.9"))
        self.assertFalse(manifest.supports_core("2.0"))
    ...
    def test_rejects_missing_identity_and_invalid_versions(self):
        ...
        bad_core_range = self._value()
        bad_core_range["core_api"] = "^1.0"
        cases.append(bad_core_range)
